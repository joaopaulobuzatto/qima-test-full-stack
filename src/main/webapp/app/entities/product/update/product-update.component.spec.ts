...
describe('Product Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Category query and add missing value', () => {
      ...
      const categoryPath: ICategory = { id: 21902 };
      product.categoryPath = categoryPath;

      const categoryCollection: ICategory[] = [{ id: 21109 }];
      jest.spyOn(categoryService, 'query').mockReturnValue(of(new HttpResponse({ body: categoryCollection })));
      const additionalCategories = [categoryPath];
    ...
    it('Should update editForm', () => {
      const product: IProduct = { id: 456 };
      const categoryPath: ICategory = { id: 13282 };
      product.categoryPath = categoryPath;

      activatedRoute.data = of({ product });
      comp.ngOnInit();

      expect(comp.categoriesSharedCollection).toContain(categoryPath);
