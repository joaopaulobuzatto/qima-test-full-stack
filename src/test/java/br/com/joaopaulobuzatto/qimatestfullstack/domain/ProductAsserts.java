...
import static br.com.joaopaulobuzatto.qimatestfullstack.domain.AssertUtils.bigDecimalCompareTo;
...
public class ProductAsserts {
    ...
    public static void assertProductUpdatableRelationshipsEquals(Product expected, Product actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getCategoryPath()).as("check categoryPath").isEqualTo(actual.getCategoryPath()));
    }
}
